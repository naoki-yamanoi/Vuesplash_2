...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  // props はその要素の属性のようなもの
  props: {
    // value は表示 / 非表示を真偽値で表現する
    value: {
      type: Boolean,
      required: true
    }
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.loading = true; // FormData API・・・Ajax でファイルを送るためのAPI

                formData = new FormData(); // photoという名前でthis.photoを持たせる。

                formData.append("photo", _this2.photo); // laravelのルートに飛ばして、戻り値受け取る。
              ...
              case 5:
                ...
                _this2.loading = false; // バリデーションエラーチェック
              ...
              case 15:
                ...
                console.log(response.data); // 写真詳細ページに移動
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)({
    // auth モジュールの apiStatus ステートを参照し、処理をするか判断
    apiStatus: function apiStatus(state) {
      return state.auth.apiStatus;
    },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: {
    // router.jsのprops: true,によりidがpropsとして送られてくる。
    id: {
      type: String,
      required: true
    }
...
var routes = [// 写真一覧ページ
{
  ...
  props: function props(route) {
    var page = route.query.page; // 整数と解釈されない値は「1」と見なしている。
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              if (response.status === _util__WEBPACK_IMPORTED_MODULE_1__.UNPROCESSABLE_ENTITY) {
                // エラーメッセージをセット
                context.commit("setLoginErrorMessages", response.data.errors); // それ以外の場合
              } else {
...
function getCookieValue(searchKey) {
  ...
  var val = ""; // document.cookieで、クッキーは、name=12345;token=67890;key=abcdeの形式で取得。
